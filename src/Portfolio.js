          ...
          <nav className="navbar navbar-expand-lg">
            <div className="container-fluid">
              <a className="navbar-brand logo " href="#">
                <img src="bio_images/logo.png" alt="Logo Picture" width="30%" />
              </a>
              <button
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md text2">
          <p className="text ">
            {" "}
            Hello there! Welcome to my world. A place where businesses and humans
            align with my juice which allows their vision fly. A place where all
            tech related issues has a solution.
          </p>
        </div>
      </div>
            ...
            <div className="col-sm-6">
              <div className="shadow p-3 mb-5 bg-body-tertiary rounded">
                <div className="card">
                  <div className="card-body">
                    <div className="ratio ratio-16x9">
                      <iframe src="gas_up.html" allowFullScreen="" />
                    </div>
                    <a
                      href="gas_up"
                      className="btn m-3"
